...
Ty = @typeside begin
    String::Ty
    Math::String; CompSci::String; English::String
    Wisnesky::String; Spivak::String; Chlipala::String; Morrisett::String
end

University = @schema Ty begin
    @entities Professor, Student, Department
    worksIn : Professor → Department
    majoringIn : Student → Department
    profName : Professor ⇒ String
    studName : Student ⇒ String
...
AdvisorMatches = @schema Ty begin
    @entities Professor, Student, Department, Match
    worksIn : Professor → Department
    majoringIn : Student → Department
    professorOf : Match → Professor
    studentOf : Match → Student
