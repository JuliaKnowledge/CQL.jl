...
Note: The sigma migration and mapping with `lambda` expressions (used for the `FindConnections` and `Merge` mappings above) still require the `cql"""..."""` string syntax. The DSL covers typesides, schemas, and instances.
