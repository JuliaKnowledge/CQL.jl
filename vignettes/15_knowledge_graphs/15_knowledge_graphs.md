...
```
    ...
    , Dict{Symbol, Set{CQLTerm}}(:Resource => Set([n_cope, n_herring, n_phyto, n_sandeel, n_cod, n_seal]), :ObjTriple => Set([e_seal_cod, e_cod_herr, e_cod_sand, e_cope_phyto, e_herr_cope, e_sand_cope]), :DataTriple => Set([p_phyto_nm, p_sand_nm, p_sand_tl, p_phyto_tl, p_cod_nm, p_cope_tl, p_herr_tl, p_herr_nm, p_cod_tl, p_cope_nm, p_seal_nm, p_seal_tl])), Dict{Symbol, CQLTerm}(:p_herr_tl => p_herr_tl, :p_seal_nm => p_seal_nm, :n_seal => n_seal, :e_cope_phyto => e_cope_phyto, :n_phyto => n_phyto, :p_cope_tl => p_cope_tl, :e_cod_sand => e_cod_sand, :e_herr_cope => e_herr_cope, :n_sandeel => n_sandeel, :e_sand_cope => e_sand_cope…), Dict{Symbol, Dict{CQLTerm, CQLTerm}}(:dt_subj => Dict(p_phyto_nm => n_phyto, p_sand_nm => n_sandeel, p_sand_tl => n_sandeel, p_phyto_tl => n_phyto, p_cod_nm => n_cod, p_cope_tl => n_cope, p_herr_tl => n_herring, p_herr_nm => n_herring, p_cod_tl => n_cod, p_cope_nm => n_cope…), :obj => Dict(e_seal_cod => n_cod, e_cod_herr => n_herring, e_cod_sand => n_sandeel, e_cope_phyto => n_phyto, e_herr_cope => n_cope, e_sand_cope => n_cope), :subj => Dict(e_seal_cod => n_seal, e_cod_herr => n_cod, e_cod_sand => n_cod, e_cope_phyto => n_cope, e_herr_cope => n_herring, e_sand_cope => n_sandeel)), Dict{CQLTerm, CQLTerm}(p_seal_tl => p_seal_tl, p_phyto_nm => p_phyto_nm, p_sand_nm => p_sand_nm, p_sand_tl => p_sand_tl, p_phyto_tl => p_phyto_tl, n_seal => n_seal, e_sand_cope => e_sand_cope, e_seal_cod => e_seal_cod, n_cope => n_cope, n_phyto => n_phyto…), Dict{Symbol, Set{CQL.TalgGen}}(:String => Set([Phytoplankton, eco:herring, eco:atlantic_cod, Copepod, eco:copepod, eco:grey_seal, Atlantic Cod, Sand Eel, name, 3, 4, 5, eco:feedsOn, trophicLevel, Herring, eco:sand_eel, 1, 2, Grey Seal, eco:phytoplankton])), CQL.var"#simplify_algebra##4#simplify_algebra##5"{Dict{Any, CQLTerm}, CQL.var"#125#126"{Dict{Symbol, Tuple{Vector{Symbol}, Symbol}}}, Vector{Tuple{CQLTerm, CQLTerm}}, Vector{Tuple{CQL.Head, CQLTerm}}}(Dict{Any, CQLTerm}(), CQL.var"#125#126"{Dict{Symbol, Tuple{Vector{Symbol}, Symbol}}}(Dict{Symbol, Tuple{Vector{Symbol}, Symbol}}()), Tuple{CQLTerm, CQLTerm}[], Tuple{CQL.Head, CQLTerm}[(CQL.Head(CQL.H_SK, Symbol("p_herr_nm.dt_pred")), name), (CQL.Head(CQL.H_SK, Symbol("n_cope.uri")), eco:copepod), (CQL.Head(CQL.H_SK, Symbol("n_herring.uri")), eco:herring), (CQL.Head(CQL.H_SK, Symbol("p_cod_nm.dt_val")), Atlantic Cod), (CQL.Head(CQL.H_SK, Symbol("p_seal_nm.dt_val")), Grey Seal), (CQL.Head(CQL.H_SK, Symbol("p_cope_nm.dt_val")), Copepod), (CQL.Head(CQL.H_SK, Symbol("p_seal_tl.dt_pred")), trophicLevel), (CQL.Head(CQL.H_SK, Symbol("e_cope_phyto.predicate")), eco:feedsOn), (CQL.Head(CQL.H_SK, Symbol("e_sand_cope.predicate")), eco:feedsOn), (CQL.Head(CQL.H_SK, Symbol("p_phyto_tl.dt_val")), 1)  …  (CQL.Head(CQL.H_SK, Symbol("p_herr_nm.dt_val")), Herring), (CQL.Head(CQL.H_SK, Symbol("n_sandeel.uri")), eco:sand_eel), (CQL.Head(CQL.H_SK, Symbol("p_seal_tl.dt_val")), 5), (CQL.Head(CQL.H_SK, Symbol("p_cope_tl.dt_val")), 2), (CQL.Head(CQL.H_SK, Symbol("p_cope_nm.dt_pred")), name), (CQL.Head(CQL.H_SK, Symbol("p_herr_tl.dt_pred")), trophicLevel), (CQL.Head(CQL.H_SK, Symbol("p_sand_tl.dt_pred")), trophicLevel), (CQL.Head(CQL.H_SK, Symbol("p_cod_tl.dt_pred")), trophicLevel), (CQL.Head(CQL.H_SK, Symbol("p_herr_tl.dt_val")), 3), (CQL.Head(CQL.H_SK, Symbol("p_phyto_tl.dt_pred")), trophicLevel)]), Dict{CQL.TalgGen, CQLTerm}(Phytoplankton => Phytoplankton, p_cod_nm.dt_val => p_cod_nm.dt_val, eco:copepod => eco:copepod, p_herr_tl.dt_val => p_herr_tl.dt_val, name => name, e_cod_herr.predicate => e_cod_herr.predicate, 4 => 4, Herring => Herring, p_cope_tl.dt_pred => p_cope_tl.dt_pred, eco:sand_eel => eco:sand_eel…), Set{Equation}())
...
```
    ...
    , Dict{Symbol, Set{CQLTerm}}(:TripleMeta => Set([ep_strength, ep_evidence]), :Resource => Set([n_herring, n_cod]), :ObjTriple => Set([ep_strength.meta_of]), :DataTriple => Set([p_herr_nm, p_cod_nm])), Dict{Symbol, CQLTerm}(:e_cod_herr => ep_strength.meta_of, :ep_evidence => ep_evidence, :p_herr_nm => p_herr_nm, :n_cod => n_cod, :n_herring => n_herring, :p_cod_nm => p_cod_nm, :ep_strength => ep_strength), Dict{Symbol, Dict{CQLTerm, CQLTerm}}(:dt_subj => Dict(p_herr_nm => n_herring, p_cod_nm => n_cod), :obj => Dict(ep_strength.meta_of => n_herring), :meta_of => Dict(ep_strength => ep_strength.meta_of, ep_evidence => ep_strength.meta_of), :subj => Dict(ep_strength.meta_of => n_cod)), Dict{CQLTerm, CQLTerm}(ep_strength => ep_strength, n_herring => n_herring, p_herr_nm => p_herr_nm, ep_evidence => ep_evidence, p_cod_nm => p_cod_nm, n_cod => n_cod, ep_strength.meta_of => ep_strength.meta_of), Dict{Symbol, Set{CQL.TalgGen}}(:String => Set([interaction_strength, high, eco:herring, eco:atlantic_cod, name, Herring, evidence, gut content analysis, eco:feedsOn, Atlantic Cod])), CQL.var"#simplify_algebra##4#simplify_algebra##5"{Dict{Any, CQLTerm}, CQL.var"#125#126"{Dict{Symbol, Tuple{Vector{Symbol}, Symbol}}}, Vector{Tuple{CQLTerm, CQLTerm}}, Vector{Tuple{CQL.Head, CQLTerm}}}(Dict{Any, CQLTerm}(), CQL.var"#125#126"{Dict{Symbol, Tuple{Vector{Symbol}, Symbol}}}(Dict{Symbol, Tuple{Vector{Symbol}, Symbol}}()), Tuple{CQLTerm, CQLTerm}[], Tuple{CQL.Head, CQLTerm}[(CQL.Head(CQL.H_SK, Symbol("p_herr_nm.dt_pred")), name), (CQL.Head(CQL.H_SK, Symbol("n_herring.uri")), eco:herring), (CQL.Head(CQL.H_SK, Symbol("p_cod_nm.dt_val")), Atlantic Cod), (CQL.Head(CQL.H_SK, Symbol("ep_strength.meta_val")), high), (CQL.Head(CQL.H_SK, Symbol("p_cod_nm.dt_pred")), name), (CQL.Head(CQL.H_SK, Symbol("ep_evidence.meta_val")), gut content analysis), (CQL.Head(CQL.H_SK, Symbol("ep_evidence.meta_key")), evidence), (CQL.Head(CQL.H_SK, Symbol("ep_strength.meta_key")), interaction_strength), (CQL.Head(CQL.H_SK, Symbol("n_cod.uri")), eco:atlantic_cod), (CQL.Head(CQL.H_SK, Symbol("ep_strength.meta_of.predicate")), eco:feedsOn), (CQL.Head(CQL.H_SK, Symbol("p_herr_nm.dt_val")), Herring)]), Dict{CQL.TalgGen, CQLTerm}(interaction_strength => interaction_strength, n_cod.uri => n_cod.uri, eco:herring => eco:herring, eco:atlantic_cod => eco:atlantic_cod, p_cod_nm.dt_val => p_cod_nm.dt_val, evidence => evidence, Atlantic Cod => Atlantic Cod, name => name, ep_evidence.meta_val => ep_evidence.meta_val, eco:feedsOn => eco:feedsOn…), Set{Equation}())
