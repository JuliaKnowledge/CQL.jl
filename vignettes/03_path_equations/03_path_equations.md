...
provides Julia-native macros. Here is how the BossDB schema and instance
look using the DSL:
...
The `@path_eq` macro declares path equations using dot notation and
`==`, directly matching the CQL `path_equations` syntax.
